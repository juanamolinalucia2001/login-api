    ...
    <div>
        ...
        <div class="container">
                    ...
                    <div class="form-group">
                      <button type="button" class="mr-2 btn btn-primary " v-on:click="editar()" >Editar</button>
                      <button type="button" class="mr-2 btn btn-danger" v-on:click="eliminar()"  >Eliminar</button>
                      <button type="button" class="mr-2 btn btn-dark " v-on:click="salir()"  >Salir</button>
                    </div> 
                </form>
        </div>
